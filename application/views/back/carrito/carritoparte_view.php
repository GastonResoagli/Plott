        ...
        <table class="table table-striped table-dark" border="0" cellpadding="5px" cellspacing="1px">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <?php // Imagen
                                $path = '<i class="fas fa-trash-alt"></i>';
                                /* <img src= '. base_url('img/cart_cross.jpg') . ' width="25px" height="20px">'; */
